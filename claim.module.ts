              ...
              'params': [
                {
                  'sender': cyberAddress,
                  'callData': callData,
                  'to': '0x0B1bbaC2A57F530C0454232082Ab061AF9cA724F',
                  'value': '0',
                  'nonce': null,
                  'maxFeePerGas': null,
              ...
              'params': [
                {
                  'sender': cyberAddress,
                  'callData': callData,
                  'to': '0xf191131dab798dd6c500816338d4b6ebc34825c7',
                  'value': '0',
                  'nonce': null,
                  'maxFeePerGas': null,
                  'maxPriorityFeePerGas': null,
            ...
            'https://api.cyberconnect.dev/wallet/',
            {
              ...
              'variables': {
                'input': {
                  ...
                  //ТУТ ПОМЕНЯТЬ КОНТРАКТ
                  'readableTransaction': `{"recipient":"${recipient}","amount":"${web3.utils.fromWei(amount, "ether")}","tokenIndex":0,"estimatedFee":{"value":"${credit}","tier":"gasPriceFast"},"token":{"name":"CyberConnect","contract":"0xf191131dab798dd6c500816338d4b6ebc34825c7","chainId":10,"decimals":18,"balance":"${amount}","symbol":"TEST CYBER","cmcTokenId":"24781","usdPrice":"","cmcUsdPrice":"","priceChange":""}}`
                }
              },
              'operationName': 'sponsorUserOperation'
            },
